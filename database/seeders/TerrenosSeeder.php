...
class TerrenosSeeder extends Seeder
{
    public function run()
    {
        Terreno::insert([
            ...
            ['id_agricultor' => 3, 'descripcion' => 'Terreno en Pampa de la Isla', 'area' => 200, 'superficie_total' => 200, 'ubicacion_latitud' => -17.62928098981144, 'ubicacion_longitud' => -63.160523858636516, 'created_at' => now(), 'updated_at' => now()],
