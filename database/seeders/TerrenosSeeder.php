...
class TerrenosSeeder extends Seeder
{
    public function run()
    {
        Terreno::insert([
            ...
            ['id_agricultor' => 2, 'descripcion' => 'Terreno en Villa Primero de Mayo', 'area' => 180, 'superficie_total' => 180, 'ubicacion_latitud' => -17.777777, 'ubicacion_longitud' => -63.182676, 'created_at' => now(), 'updated_at' => now()],
